...
local project_ports = {
    ["oab-back"] = 40001,
    ["oab-distribuicao-back"] = 40002,
    ["oab-jurisprudencia-backend"] = 40003,
    ["oab-pautas-backend"] = 40004,
    ["oab-assinatura-back"] = 40005,
    ["pp-consurso-backend"] = 40006,
    ["primo-invest-backend"] = 40007,
    ["up-jira"] = 40008
}
...
require("mcphub").setup({
    workspace = {
        ...
        get_port = function(min, max)
            local current_dir = vim.fn.fnamemodify(vim.fn.getcwd(), ":t")
            print("Current directory: " .. current_dir)
            return project_ports[current_dir] or min
        end,
    },
})
...
require("codecompanion").setup({
    ...
    opts = { log_level = "TRACE,DEBUG,INFO,ERROR" },
