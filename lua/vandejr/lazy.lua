...
require("lazy").setup({
    ...
    {
        "VandeJr/diffnav.nvim",
        config = function()
            require("diffnav").setup()
        end,

        keys = {
            { "<leader>qv", "<cmd>Diffnav<cr>",              desc = "Toggle Diffnav" },
            { "<leader>qs", "<cmd>DiffnavStage<cr>",         desc = "DiffStage" },
            { "<leader>qS", "<cmd>DiffnavUnstage<cr>",       desc = "DiffUnstage" },
            { "<leader>qm", "<cmd>DiffnavMergeCurrent<cr>",  desc = "DiffMergeCurr" },
            { "<leader>qM", "<cmd>DiffnavMergeIncoming<cr>", desc = "DiffMergeIncoming" },
            { "<leader>qb", "<cmd>DiffnavMergeBoth<cr>",     desc = "DiffMergeBoth" },
            { "<leader>qv", "<cmd>DiffnavStatus<cr>",        desc = "DiffStatus" },
            { "<leader>qV", "<cmd>DiffnavConflicts<cr>",     desc = "DiffConflicts" },
            { "<leader>qf", "<cmd>DiffnavFloat<cr>",         desc = "DiffFloat" },
        }
    },
})
